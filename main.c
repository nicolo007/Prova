...
int main() {
	...
	float xmax= 5.0; 					
	int intervals = 100; 					/* number of equally spaced intervals */ 
	...
	if (fvalues == NULL) {									//
		printf("\nERROR: cannot allocate memory\n");		// CONTROLLO SULLA CORRETTA ALLOCAZIONE DI MEMEMORIA [Obbligatorio]
		exit(-1);											// SCRIVERE ANCHE LA DE-ALLOCAZIONE
	}
